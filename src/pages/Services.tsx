...
import { FiCode, FiSmartphone, FiImage, FiDatabase, FiCloud, FiShield } from 'react-icons/fi';
import Navbar from '../components/Navbar';
import Footer from '../components/Footer';
import { useLanguage } from '../contexts/LanguageContext';

// Type cast icons
const CodeIcon = FiCode as React.ComponentType<any>;
const SmartphoneIcon = FiSmartphone as React.ComponentType<any>;
const PaletteIcon = FiImage as React.ComponentType<any>;
const DatabaseIcon = FiDatabase as React.ComponentType<any>;
const CloudIcon = FiCloud as React.ComponentType<any>;
const ShieldIcon = FiShield as React.ComponentType<any>;
